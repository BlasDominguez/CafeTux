    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <center><a href="../../_index.html" id="regresa">X</a></center> 
            ...
            <div class="card-body">
                <form action="../controlador/validaRegistro.php" method="POST" >
                    ...
                    <div class="form-floating mb-3">
                        <input type="nombre" name="nombre" class="form-control" id="floatingInput" placeholder="name@example.com">
                        <label for="floatingInput">Nombre</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="apellido" name="apellido" class="form-control" id="floatingInput" placeholder="name@example.com">
                        <label for="floatingInput">Apellido</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="direccion" name="direccion" class="form-control" id="floatingInput" placeholder="name@example.com">
                        <label for="floatingInput">Dirección</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="telefono" name="telefono" class="form-control" id="floatingInput" placeholder="name@example.com">
